...
import (
	...
	"github.com/timenewbank/go-mit/signer/core"
	"github.com/timenewbank/go-mit/signer/rules"
	"github.com/timenewbank/go-mit/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Mit account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
