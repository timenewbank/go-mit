...
// Package bind generates Mit contract Go bindings.
//
// Detailed usage document and tutorial available on the go-mit Wiki page:
// https://github.com/timenewbank/go-mit/wiki/Native-DApps:-Go-bindings-to-Mit-contracts
package bind
